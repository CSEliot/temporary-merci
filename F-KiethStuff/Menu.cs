...
public class Menu : MonoBehaviour {
	...
	void OnGUI()
	{
		...
		GUI.Box (guiMenu,"EMT Merci UMBC Game development club"); 


		Rect rectangle0 = new Rect (width/2 - widthSegment * 1, height/2 - heightSegment * 10,
		...
		*/
		...
		Rect rectangle2 = new Rect (width/2 - widthSegment * 1, height/2 - heightSegment * 2,
		                            widthSegment * 2, heightSegment * 2);
